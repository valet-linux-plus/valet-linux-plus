...
class Server
{
    ...
    {
        return rawurldecode(explode('?', $requestUri)[0]);
    }
     ...
     *
     * E.g. URL is 192.168.1.100/domain.test/auth/login, passes $uri as domain.test/auth/login and
     * $tld as 'test', and this method returns `domain.test`
     *
